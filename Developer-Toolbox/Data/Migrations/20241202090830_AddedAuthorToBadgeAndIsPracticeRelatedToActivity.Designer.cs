...
namespace Developer_Toolbox.Data.Migrations
{
    ...
    [Migration("20241202090830_AddedAuthorToBadgeAndIsPracticeRelatedToActivity")]
    partial class AddedAuthorToBadgeAndIsPracticeRelatedToActivity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BadgeTag", b =>
                {
                    b.Property<int>("RelatedBadgesId")
                        .HasColumnType("int");

                    b.Property<int>("TargetTagsId")
                        .HasColumnType("int");

                    b.HasKey("RelatedBadgesId", "TargetTagsId");

                    b.HasIndex("TargetTagsId");
            ...
            modelBuilder.Entity("BadgeTag", b =>
                {
                    ...
                    b.HasOne("Developer_Toolbox.Models.Tag", null)
                        .WithMany()
                        .HasForeignKey("TargetTagsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
