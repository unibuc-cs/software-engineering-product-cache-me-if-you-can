...
namespace Developer_Toolbox.Interfaces
{
    public interface IEmailService
    {
        ...
        Task SendAlmostEndedChallengeEmailAsync(string userEmail, string userName, WeeklyChallenge challenge);
        Task SendEndedChallengeEmailAsync(string userEmail, string userName, WeeklyChallenge challenge);
